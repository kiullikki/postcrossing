  ...
  <body>
    <div class="container col-md-4 col-md-offset-4" role="main">
      ...
      <form id="coreschema" novalidate>
        {% for key, schema in parent.properties.items() %} {% set template_path
        = determine_html_template(schema) %} {% set required = key in
        parent.required %} {% include template_path %} {% endfor %}
      </form>
      <pre></pre>
    </div>
    <!-- /container -->
