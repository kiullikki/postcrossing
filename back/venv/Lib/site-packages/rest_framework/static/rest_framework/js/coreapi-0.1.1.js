  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          function primitiveToNode(data, baseUrl) {
            ...
            if (isObject && data._type === 'document') {
              ...
              var _url = _relativeUrl
                ? URL(_relativeUrl, baseUrl).toString()
                : '';
      ...
      15: [
        function (require, module, exports) {
          ...
          var determineTransport = function determineTransport(
            transports,
            url
          ) {
      ...
      21: [
        function (require, module, exports) {
          (function (root, factory) {
             ...
             * @return {string}
             */
            UrlTemplate.prototype.encodeValue = function (
              operator,
              value,
              key
            ) {
