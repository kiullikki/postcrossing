...
<html lang="en">
  <head>
    ...
    />
    <link
      href="{% static 'rest_framework/css/bootstrap-theme.min.css' %}"
      rel="stylesheet"
    />
    <link
      href="{% static 'rest_framework/css/font-awesome-4.0.3.css' %}"
      rel="stylesheet"
    />
    <link
      href="{% static 'rest_framework/docs/css/base.css' %}"
      rel="stylesheet"
    />
    <link
      href="{% static 'rest_framework/docs/css/jquery.json-view.min.css' %}"
      rel="stylesheet"
    />

    <link
      href="{% static 'rest_framework/docs/img/favicon.ico' %}"
      rel="shortcut icon"
    />
  ...
  <body data-spy="scroll" data-target="#sidebar-nav" data-offset="50">
    ...
    {% include "rest_framework/docs/auth/token.html" %} {% include
    "rest_framework/docs/auth/basic.html" %} {% include
